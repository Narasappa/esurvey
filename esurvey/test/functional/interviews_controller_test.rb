...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { mobile_number: @interview.mobile_number, name: @interview.name, voter_id: @interview.voter_id }
    end
  ...
  test "should update interview" do
    put :update, id: @interview, interview: { mobile_number: @interview.mobile_number, name: @interview.name, voter_id: @interview.voter_id }
    assert_redirected_to interview_path(assigns(:interview))
  end
