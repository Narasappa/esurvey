class PoliticalPartiesController < ApplicationController
  ...
  def index
    ...
    @active_political_parties = PoliticalParty.active
    @inactive_political_parties = PoliticalParty.inactive
  ...
  def edit
    @political_party = PoliticalParty.find(params[:id]) 
    @political_party.build_picture if @political_party.picture.nil?  
  end
  ...
  def destroy
    @political_party = PoliticalParty.find(params[:id])
    @political_party.update_attributes(:is_active=> !@political_party.is_active)
    respond_to do |format|
